 ...
 * @since November 2016
 * @version 0.1
 * @description Levenshtein - Implementation of the algorithm - details https://en.wikipedia.org/wiki/Levenshtein_distance
...
public class Levenshtein extends StringAlgo{
    protected static final long serialVersionUID = 3L;
    
    public Levenshtein(String str1, String str2) throws RemoteException {
        super(str1, str2);
    }
